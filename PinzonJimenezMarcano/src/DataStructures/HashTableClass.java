...
public class HashTableClass {
    ...
    // The hashtable will alwais be created 3 times bigger than the cuantity needed,
    // so it can avoid collisions
    ...
    public void put(Guest guest, int room) {
        ...
        if (isFull()) {
            ...
            if (room > maxCapacity || room < 1) {
                System.out.println("The room " + room + " does not exist." + " Can't add " + guest.getFirstName() + " "
                        + guest.getLastName());
                return;
            }
    ...
    /*
     * Given a firstname and a lastname String, it searches the hashtable and
     * returns the room number of all
    ...
    public String getGuestRoom(String firstName, String lastName) {
        ...
        Guest guest = new Guest(firstName, lastName); // Este Guest creado solo sirve para generar el hashcode, no
    ...
    public Guest deleteGuest(Guest guestToDelete) {
        ...
        if (getTable()[index] == null) {
            System.out.println(guestToDelete.getFullName() + " isn't staying at the hotel"); // Posible nullpointer, si
                                                                                             // no encuentra el Guest
        ...
        for (int i = 0; i != tableSize; i++) {
            ...
            if (getTable()[i] != null) {
                ...
                while (pointer != null) {
                    ...
                    System.out.println("[ " + guestToPrint.getFirstName() + " " + guestToPrint.getLastName() + ": Room "
                            + guestToPrint.getRoom() + " ]");
                    pointer = pointer.getNext();
                }
            }
        }
